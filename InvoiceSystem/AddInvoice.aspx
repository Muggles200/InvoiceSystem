<%@ Page Title="Add Invoice" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddInvoice.aspx.cs" Inherits="InvoiceSystem.AddInvoice" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
            <hr />
            <asp:Button ID="btnSave" runat="server" Text="Save Invoice" CssClass="btn btn-primary" OnClick="btnSave_Click" />
